...
**Queue** is our FiveM resource for managing join queues. Control who gets in and when with configurable slots, priority rules, and messaging—so your server stays full without the guesswork.
...
<CardGroup cols={2}>
  ...
  <Card title="Commands" icon="terminal" href="/queue/commands">
    In-game and console commands.
  </Card>
  <Card title="Events" icon="bolt" href="/queue/events">
    Client and server events for integrations.
  </Card>
  <Card title="Exports" icon="code" href="/queue/exports">
    Use Queue from other resources.
  </Card>
</CardGroup>
